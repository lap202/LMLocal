...
{
    internal class VsActiveWindow
    {
        public async Task<string> GetContentAsync()
        {
            var (_, text) = await this.GetActiveTextDocumentAsync();
            return text;
        }

        public async Task<(string filePath, string content)> GetActiveTextDocumentAsync()
        {
